	...
	<section class="banner-bottom-wthreelayouts py-lg-5 py-3">
		<div class="container-fluid">
			<div class="inner-sec-shop px-lg-4 px-3">
					<!-- / New arrivals -->
				<!-- <h3 class="tittle-w3layouts my-lg-4 my-4" style="color: #800020;">New Arrivals for you </h3> -->
					<!-- // New arrivals -->
				<!-- <div class="row"> -->
					<!-- /womens -->
						...
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="<?php echo(base_url()); ?>assets/images/s1.jpg" class="img-fluid" alt="">
					...
					<div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="<?php echo(base_url()); ?>assets/images/s2.jpg" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
					...
					<div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="<?php echo(base_url()); ?>assets/images/s3.jpg" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
					...
					<div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="<?php echo(base_url()); ?>assets/images/s4.jpg" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
				...
				<!-- <div class="row mt-lg-3 mt-0"> -->
					...
					<div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="<?php echo(base_url()); ?>assets/images/m2.jpg" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
				...
				<!-- <div class="row">
					<div class="col-md-12 middle-slider my-4">
						<div class="middle-text-info ">
							...
							<h3 class="tittle-w3layouts two text-center my-lg-4 mt-3">Black Friday Count Down</h3>
				...
				<div class="row galsses-grids pt-lg-5 pt-3">
					<div class="col-lg-6 galsses-grid-left">
						<figure class="effect-lexi">
							<img src="<?php echo(base_url()); ?>assets/images/ed1.jpg" alt="" class="img-fluid">
							<figcaption>
								<h3>Erekha Spice
									<span>Fabrics</span>
								</h3>
					...
					<div class="col-lg-6 galsses-grid-left">
						<figure class="effect-lexi">
							<img src="<?php echo(base_url()); ?>assets/images/ed2.jpg" alt="" class="img-fluid">
							<figcaption>
								<h3>Erekha Spice
									<span>Clothes</span>
								</h3>
					...
					<!-- /satisfaction guaranteed and UV protection part -->
				<!-- /grids -->
				...
				<div class="testimonials p-lg-5 p-3 mt-4">
					<div class="row last-section">
						<div class="col-lg-4 footer-top-w3layouts-grid-sec" align="center">
							<div class="mail-grid-icon text-center">
								<i class="fas fa-gift"></i>
							</div>
							<div class="mail-grid-text-info">
								<h3>Guaranteed Satisfaction</h3>
								<p style="color: #000000;">Lorem ipsum dolor sit amet, consectetur</p>
							</div>
						</div>
						<div class="col-lg-4 footer-top-w3layouts-grid-sec" align="center">
							<div class="mail-grid-icon text-center">
