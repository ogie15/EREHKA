...
<section class="banner-bottom-wthreelayouts py-lg-5 py-3">
			<div class="container-fluid">
				<div class="inner-sec-shop px-lg-4 px-3">
					<h3 class="tittle-w3layouts my-lg-4 mt-3">FABRICS </h3>
					<div class="row">
						<!-- product left -->
						<div class="side-bar col-lg-3">
							...
							<div class="deal-leftmk left-side">
								<h3 class="agileits-sear-head">Clothings...</h3>
							...
							<div class="wrapper_top_shop">
								<!-- <div class="row"> -->
										<!-- <div class="col-md-6 shop_left"> -->
												<!-- <img src="<?php echo(base_url());?>assets/images/ed1.jpg" alt=""> -->
												<!-- <h6>40% off</h6> -->
											<!-- </div> -->
											<!-- <div class="col-md-6 shop_right"> -->
												<!-- <img src="<?php echo(base_url());?>assets/images/ed2.jpg" alt=""> -->
												<!-- <h6>50% off</h6> -->
											<!-- </div> -->
